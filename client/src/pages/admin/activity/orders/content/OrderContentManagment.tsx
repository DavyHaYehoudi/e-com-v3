...
const OrderContentManagement: React.FC<OrderContentManagementProps> = ({
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="md:w-[500px] min-w-[310px]">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid gap-6">
            ...
            {/* Retour */}
            <div className="space-y-4 bg-amber-50 dark:bg-amber-900 p-4 rounded">
              <h6 className="font-medium underline underline-offset-4 text-amber-700 dark:text-amber-300">
                Retour
              </h6>
            ...
            {/* Échange */}
            <div className="space-y-4 bg-violet-50 dark:bg-violet-900 p-4 rounded">
              <h6 className="font-medium underline underline-offset-4 text-violet-700 dark:text-violet-300">
                Echange
              </h6>
              <div className="grid grid-cols-3 items-center gap-4">
            ...
            {/* Remboursement */}
            <div className="space-y-4 bg-rose-50 dark:bg-rose-900 p-4 rounded">
              <h6 className="font-medium underline underline-offset-4 text-rose-700 dark:text-rose-300">
                Remboursement
              </h6>
              <div className="grid grid-cols-3 items-center gap-4">
